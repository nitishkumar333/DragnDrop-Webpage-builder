...
const SettingsTab = (props: Props) => {
  ...
  const handleOnChanges = (e: any) => {
    ...
    if (styleSettings === "fontSize") {
      ...
      value += "px";
    } else if (styleSettings === "backgroundImage") {
              ...
              {state.editor.selectedElement.type === "video" &&
                !Array.isArray(state.editor.selectedElement.content) && (
                  <div className="flex flex-col gap-2">
                    <p className="text-muted-foreground">Youtube Embed link</p>
                    <Input
                      id="href"
                      placeholder="https://www.youtube.com/embed/9Je_iSH_fEU?si=nfMow0cJHeUhR2E8"
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      ...
                      <small className="p-2">
                        {typeof state.editor.selectedElement.styles
                          ?.fontSize === "number"
                          ? state.editor.selectedElement.styles?.fontSize
                          : parseFloat(
                              (
                                state.editor.selectedElement.styles?.fontSize ||
                                "0"
                    ...
                    <Slider
                      ...
                      value={[
                        typeof state.editor.selectedElement.styles?.fontSize ===
                        "number"
                          ? state.editor.selectedElement.styles?.fontSize
                          : parseFloat(
                              (
